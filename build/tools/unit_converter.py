TOOL = {
    ...
    "i18n": {
        ...
        "sk": {"name": 'Konvertor jednotiek', "tagline": 'Preveď medzi metrickými a imperiálnymi jednotkami dĺžky, hmotnosti, teploty, objemu a plochy.', "description": 'Bezplatný online konvertor jednotiek. Preveď medzi metrickými a imperiálnymi jednotkami — dĺžka, hmotnosť, teplota, objem a plocha. Beží v prehliadači, bez registrácie.'},
