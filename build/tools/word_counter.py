TOOL = {
    ...
    "i18n": {
        ...
        "de": {"name": "Wortzähler", "tagline": "Zähle Wörter, Zeichen, Sätze, Absätze und schätze Lese- und Sprechzeit live, während du tippst.", "description": "Kostenloser Wortzähler. Live-Zählung von Wörtern, Zeichen (mit/ohne Leerzeichen), Sätzen, Absätzen, Silben sowie Lese- und Sprechzeitschätzung."},
