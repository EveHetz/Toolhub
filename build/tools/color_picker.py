...
""",
    "help": {
        "en": """
<h2>How it works</h2>
<p>Use the native picker, or paste a HEX, <code>rgb()</code>, or <code>hsl()</code> value. The opacity slider applies an alpha channel that's reflected in <code>RGBA</code>, <code>HSLA</code>, and the 8-digit <code>HEX8</code> form.</p>
<h3>When to use each space</h3>
<ul>
  <li><strong>HEX / RGB</strong> — CSS, design tools, email templates.</li>
  <li><strong>HSL</strong> — readable palettes; tweak hue, saturation, or lightness without changing the others.</li>
  <li><strong>HSV</strong> — design software (Photoshop, Figma) for shading.</li>
  <li><strong>CMYK</strong> — print-ready output. Note: screens are RGB, so CMYK here is an approximate conversion.</li>
</ul>
""",
    },
