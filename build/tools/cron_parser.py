...
<ul>
  <li>If both day-of-month and day-of-week are restricted, most cron implementations OR them — this tool follows that convention.</li>
  <li><code>*/N</code> means "every N", starting from the lower bound.</li>
  <li>Step values can combine with ranges: <code>0-30/5</code> = 0,5,10,…,30.</li>
  <li>The next-fire calculation is in your browser's local timezone.</li>
</ul>
""",
    },
