...
<p>Lorem ipsum is scrambled Latin text derived from Cicero's <em>De Finibus Bonorum et Malorum</em> (45 BC), used since the 1500s as filler in typography and printing because its character frequencies and word lengths roughly match real prose without being readable enough to distract.</p>
<h3>When to use it</h3>
<ul>
  <li><strong>Mockups</strong> — placeholder for "the words don't matter, the layout does".</li>
  <li><strong>Design comps</strong> — testing wrapping, line lengths, font fallbacks.</li>
  <li><strong>CMS placeholders</strong> — until real copy arrives.</li>
</ul>
<h3>When not to use it</h3>
<p>Don't ship it to production. Lorem ipsum has been published live more than once because nobody swapped it for the real copy.</p>
""",
    },
