...
<p>A structural diff: walks both JSON trees and reports each path where they differ. Output paths use <a href="https://datatracker.ietf.org/doc/html/rfc6901" target="_blank" rel="noopener noreferrer">RFC 6901 JSON Pointer</a> syntax (<code>/users/0/name</code>).</p>
<h3>Modes</h3>
<ul>
  <li><strong>Changes only</strong> — list of add/remove/change operations.</li>
  <li><strong>Full side-by-side</strong> — same data, easier scanning.</li>
  <li><strong>JSON Patch (RFC 6902)</strong> — emits a valid patch document you can apply with any RFC 6902 implementation.</li>
</ul>
<h3>Array comparison</h3>
<ul>
  <li><strong>By index</strong> — strict positional comparison, like <code>diff</code>. Item moves show as remove + add.</li>
  <li><strong>By value</strong> — treats arrays as multisets; ignores order. Useful for tag lists, IDs, etc.</li>
</ul>
""",
    },
