...
""",
    "help": {
        "en": """
<h2>How it works</h2>
<p>Uses JavaScript <code>BigInt</code> internally so values aren't capped at 2<sup>53</sup>. Negative numbers carry through. Underscore digit grouping is accepted (<code>1_000_000</code>).</p>
...
<h3>Bit width</h3>
<p>The "bits" indicator shows the minimum number of bits needed to represent the absolute value (plus one sign bit for negatives in two's complement).</p>
""",
    },
