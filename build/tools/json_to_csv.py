...
""",
        "id": """
<h2>Untuk apa ini?</h2>
<p>Perjalanan kebalikannya: masukkan sebuah JSON array dan dapatkan CSV yang siap untuk Excel, Google Sheets, atau data tool apa pun yang lebih suka format tabular. Header dideteksi otomatis dari key object; nested value akan di-JSON-stringify ke dalam sel tunggal sehingga tidak ada yang hilang diam-diam.</p>

<h3>Kapan digunakan</h3>
<ul>
  <li>Mengubah response API menjadi CSV untuk stakeholder yang hanya membuka spreadsheet.</li>
  <li>Mengekspor banyak record dari sebuah JSON dump menjadi sesuatu yang bisa kamu pivot/filter di Sheets.</li>
  <li>Menghasilkan fixture row untuk database import yang menerima CSV.</li>
</ul>

<h3>Kesalahan umum</h3>
<ul>
  <li><strong>Inferensi header memakai union dari semua key object.</strong> Row yang tidak punya sebuah key akan jadi sel kosong; kolomnya tidak hilang.</li>
...
<p>उल्टा रास्ता: एक JSON array feed करें और Excel, Google Sheets, या किसी भी data tool के लिए तैयार CSV पाएं जो tabular formats को प्राथमिकता देते हैं। Headers object keys से auto-detect होते हैं; nested values single cells में JSON-stringified हो जाते हैं ताकि कुछ भी चुपके से गायब न हो।</p>

<h3>कब इस्तेमाल करें</h3>
<ul>
  <li>उस stakeholder के लिए API response को CSV में बदलना जो केवल spreadsheets खोलता है।</li>
  <li>JSON dump से रिकॉर्ड्स के ढेर को कुछ ऐसी चीज़ में export करना जिसे आप Sheets में pivot/filter कर सकें।</li>
  <li>CSV लेने वाले database imports के लिए fixture rows generate करना।</li>
</ul>

<h3>आम गलतियाँ</h3>
<ul>
  <li><strong>Header inference सभी object keys के union का उपयोग करता है।</strong> एक key गायब वाला row खाली cell बन जाता है; column गायब नहीं होता।</li>
