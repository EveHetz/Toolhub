TOOL = {
    ...
    "i18n": {
        ...
        "sk": {"name": 'BMI kalkulačka', "tagline": 'Body Mass Index z výšky a hmotnosti. Metrické alebo imperiálne jednotky. Zobrazí WHO kategóriu — nie je to medicínska rada.', "description": 'Bezplatná online BMI kalkulačka. Zadaj výšku a hmotnosť v metrických alebo imperiálnych jednotkách a získaj svoj Body Mass Index s WHO kategóriou. Bez registrácie, bez sledovania.'},
