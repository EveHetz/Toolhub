...
UI = i18n_mod.UI
LANGS = i18n_mod.LANGS  # ["en", "de", "es", "fr", "it", "pt", "pl", "ja", "nl", "tr", "id"]
...
OG_LOCALES = {"en": "en_GB", "de": "de_DE", "es": "es_ES", "fr": "fr_FR", "it": "it_IT", "pt": "pt_BR", "pl": "pl_PL", "ja": "ja_JP", "nl": "nl_NL", "tr": "tr_TR", "id": "id_ID"}
...
NOUNS = {
    "text":     {"en": "text",     "de": "Text",     "es": "texto",    "fr": "texte",    "it": "testo",    "pt": "texto",    "pl": "tekst",    "ja": "テキスト",   "nl": "tekst",      "tr": "metin",      "id": "teks"},
    "password": {"en": "password", "de": "Passwort", "es": "contraseña","fr": "mot de passe","it": "password","pt": "senha",  "pl": "hasło",    "ja": "パスワード", "nl": "wachtwoord", "tr": "parola",     "id": "kata sandi"},
    "image":    {"en": "image",    "de": "Bild",     "es": "imagen",   "fr": "image",    "it": "immagine", "pt": "imagem",   "pl": "obraz",    "ja": "画像",       "nl": "afbeelding", "tr": "görsel",     "id": "gambar"},
    "color":    {"en": "color",    "de": "Farbe",    "es": "color",    "fr": "couleur",  "it": "colore",   "pt": "cor",      "pl": "kolor",    "ja": "色",         "nl": "kleur",      "tr": "renk",       "id": "warna"},
    "date":     {"en": "date",     "de": "Datum",    "es": "fecha",    "fr": "date",     "it": "data",     "pt": "data",     "pl": "data",     "ja": "日付",       "nl": "datum",      "tr": "tarih",      "id": "tanggal"},
    "time":     {"en": "time",     "de": "Zeit",     "es": "hora",     "fr": "heure",    "it": "ora",      "pt": "hora",     "pl": "czas",     "ja": "時刻",       "nl": "tijd",       "tr": "saat",       "id": "waktu"},
    "timestamp":{"en": "timestamp","de": "Timestamp","es": "timestamp","fr": "timestamp","it": "timestamp","pt": "timestamp","pl": "znacznik czasu","ja": "タイムスタンプ","nl": "timestamp",  "tr": "timestamp",  "id": "timestamp"},
    "number":   {"en": "number",   "de": "Zahl",     "es": "número",   "fr": "nombre",   "it": "numero",   "pt": "número",   "pl": "liczba",   "ja": "数値",       "nl": "getal",      "tr": "sayı",       "id": "angka"},
    "shadow":   {"en": "shadow",   "de": "Schatten", "es": "sombra",   "fr": "ombre",    "it": "ombra",    "pt": "sombra",   "pl": "cień",     "ja": "シャドウ",   "nl": "schaduw",    "tr": "gölge",      "id": "bayangan"},
    "gradient": {"en": "gradient", "de": "Verlauf",  "es": "degradado","fr": "dégradé",  "it": "gradiente","pt": "gradiente","pl": "gradient", "ja": "グラデーション","nl": "gradiënt",  "tr": "gradyan",    "id": "gradien"},
    "file size":{"en": "file size","de": "Dateigröße","es": "tamaño de archivo","fr": "taille de fichier","it": "dimensione file","pt": "tamanho de arquivo","pl": "rozmiar pliku","ja": "ファイルサイズ","nl": "bestandsgrootte","tr": "dosya boyutu","id": "ukuran file"},
    "unit":     {"en": "unit",     "de": "Einheit",  "es": "unidad",   "fr": "unité",    "it": "unità",    "pt": "unidade",  "pl": "jednostka","ja": "単位",       "nl": "eenheid",    "tr": "birim",      "id": "satuan"},
    "percentage":{"en":"percentage","de":"Prozentwert","es":"porcentaje","fr":"pourcentage","it":"percentuale","pt":"porcentagem","pl":"procent","ja":"パーセント","nl":"percentage", "tr":"yüzde",       "id":"persentase"},
    "table":    {"en": "table",    "de": "Tabelle",  "es": "tabla",    "fr": "tableau",  "it": "tabella",  "pt": "tabela",   "pl": "tabela",   "ja": "表",         "nl": "tabel",      "tr": "tablo",      "id": "tabel"},
    "bill":     {"en": "bill",     "de": "Rechnung", "es": "cuenta",   "fr": "addition", "it": "conto",    "pt": "conta",    "pl": "rachunek", "ja": "請求額",     "nl": "rekening",   "tr": "hesap",      "id": "tagihan"},
    "card number":{"en":"card number","de":"Kartennummer","es":"número de tarjeta","fr":"numéro de carte","it":"numero di carta","pt":"número do cartão","pl":"numer karty","ja":"カード番号","nl":"kaartnummer","tr":"kart numarası","id":"nomor kartu"},
    "email":    {"en": "email",    "de": "E-Mail",   "es": "correo",   "fr": "e-mail",   "it": "email",    "pt": "e-mail",   "pl": "e-mail",   "ja": "メール",     "nl": "e-mail",     "tr": "e-posta",    "id": "email"},
    "cron expression":{"en":"cron expression","de":"Cron-Ausdruck","es":"expresión cron","fr":"expression cron","it":"espressione cron","pt":"expressão cron","pl":"wyrażenie cron","ja":"cron 式","nl":"cron-expressie","tr":"cron ifadesi","id":"ekspresi cron"},
    "query string":{"en":"query string","de":"Query-String","es":"cadena de consulta","fr":"chaîne de requête","it":"stringa di query","pt":"query string","pl":"query string","ja":"クエリ文字列","nl":"query-string","tr":"query string","id":"query string"},
    "color pair":{"en":"color pair","de":"Farbpaar","es":"par de colores","fr":"paire de couleurs","it":"coppia di colori","pt":"par de cores","pl":"para kolorów","ja":"色のペア","nl":"kleurenpaar","tr":"renk çifti","id":"pasangan warna"},
    "roll":     {"en": "dice roll","de": "Würfelwurf","es":"tirada",   "fr": "lancer",   "it": "lancio",   "pt": "rolagem",  "pl": "rzut",     "ja": "ロール",     "nl": "worp",       "tr": "zar atışı",  "id": "lemparan dadu"},
    "slug":     {"en": "slug",     "de": "Slug",     "es": "slug",     "fr": "slug",     "it": "slug",     "pt": "slug",     "pl": "slug",     "ja": "スラッグ",   "nl": "slug",       "tr": "slug",       "id": "slug"},
}
